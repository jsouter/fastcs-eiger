...
async def test_EigerHandler_after_put(mock_connection):
    ...
    # parameters with EigerHandler handlers do not get updated when controller update is called
...
async def test_EigerHandler_update_updates_value(mock_connection):
    ...
    mock_connection.get = _get_1_as_value  # show that value changes after update is awaited
